...
GovObjectController.prototype.submit = function (req, res) {
  ...
  this.node.services.trivechaind.govObjectSubmit(parentHash, revision, time, dataHex, feeTxId, function(err, result) {
...
GovObjectController.prototype.govObjectList = function(options, callback) {
    this.node.services.trivechaind.govObjectList(options, function(err, result) {
        if (err) {
            return callback(err);
        }
...
GovObjectController.prototype.getHash = function(hash, callback) {
    ...
    this.node.services.trivechaind.govObjectHash(hash, function(err, result) {
        if (err) {
            return callback(err);
        }
...
GovObjectController.prototype.govObjectCheck = function(req, res) {
  ...
  this.node.services.trivechaind.govObjectCheck(hexdata, function(err, result) {
    if (err) {
      return self.common.handleErrors(err, res);
    }
    res.jsonp(result);
...
GovObjectController.prototype.getInfo = function (req, res) {
  var self = this;
  this.node.services.trivechaind.govObjectInfo(function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.getCount = function (req, res) {
  var self = this;
  this.node.services.trivechaind.govCount(function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectVotes = function (req, res) {
  ...
  this.node.services.trivechaind.getVotes(govHash, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectCurrentVotes = function (req, res) {
  ...
  this.node.services.trivechaind.getCurrentVotes(govHash, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectDeserialize = function (req, res) {
  ...
  this.node.services.trivechaind.govObjectDeserialize(hexdata, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
